...
const CRC_SIZES: &[usize] = &[
    0, 1, 3, 4, 7, 8, 9, 15, 16, 17, 31, 32, 63, 64, 65, 127, 128, 129, 191, 192, 193, 207, 208,
    209, 239, 240, 241, 255, 256, 257, 383, 384, 385, 1023, 1024, 1025, 4095, 4096, 4097, 8191,
    8192, 8193, 16_383, 16_384, 16_385, 65_536, 1_048_576,
];
const CRC_UNALIGNED_SIZES: &[usize] = &[32, 128, 256, 4096, 65_536, 1_048_576];
...
mod crc32_iso_hdlc {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            ...
            .bench(|| hashcrew::crc::crc32_iso_hdlc(black_box(&bytes)));
    }

    #[divan::bench(args = CRC_SIZES)]
    fn crc_table_1(bencher: Bencher<'_, '_>, len: usize) {
        let bytes = input(len);
        bencher
            .counter(BytesCount::new(len))
            .bench(|| REFERENCE.checksum(black_box(&bytes)));
    }

    #[divan::bench(args = CRC_SIZES)]
    fn crc_table_16(bencher: Bencher<'_, '_>, len: usize) {
        let bytes = input(len);
        bencher
            .counter(BytesCount::new(len))
            .bench(|| REFERENCE_16.checksum(black_box(&bytes)));
    }

    #[divan::bench(args = CRC_SIZES)]
    fn crc32fast(bencher: Bencher<'_, '_>, len: usize) {
        let bytes = input(len);
        bencher
            .counter(BytesCount::new(len))
    ...
    fn crc_fast_generic(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| crc_fast::checksum(crc_fast::CrcAlgorithm::Crc32IsoHdlc, black_box(&bytes)));
    }

    #[divan::bench(args = CRC_UNALIGNED_SIZES)]
    fn hashcrew_unaligned(bencher: Bencher<'_, '_>, len: usize) {
    ...
    fn crc_fast_unaligned(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| crc_fast::crc32_iso_hdlc(black_box(&bytes[1..])));
    }
}
...
mod crc32_iscsi {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::crc::crc32_iscsi(black_box(&bytes)));
    }
    ...
    fn crc_fast_generic(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| crc_fast::checksum(crc_fast::CrcAlgorithm::Crc32Iscsi, black_box(&bytes)));
    }
    ...
    fn crc_fast_unaligned(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| crc_fast::crc32_iscsi(black_box(&bytes[1..])));
    }
}
...
mod cityhash32 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::cityhash::cityhash32(black_box(&bytes)));
    }
...
mod cityhash64 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::cityhash::cityhash64(black_box(&bytes)));
    }
...
mod cityhash64_seeded {
    ...
    #[divan::bench(args = SIZES)]
    fn hashcrew_one_seed(bencher: Bencher<'_, '_>, len: usize) {
        let bytes = input(len);
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::cityhash::cityhash64_with_seed(black_box(&bytes), SEED));
    }

    #[divan::bench(args = SIZES)]
    fn hashcrew_two_seeds(bencher: Bencher<'_, '_>, len: usize) {
        let bytes = input(len);
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::cityhash::cityhash64_with_seeds(black_box(&bytes), SEED, !SEED));
    }
...
mod cityhash128 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::cityhash::cityhash128(black_box(&bytes)));
    }
...
mod cityhash128_seeded {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::cityhash::cityhash128_with_seed(black_box(&bytes), seed));
    }
}
...
mod xxh32 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::xxhash::xxh32(black_box(&bytes), 0));
    }
...
mod xxh64 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::xxhash::xxh64(black_box(&bytes), 0));
    }
...
mod xxh3_64 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::xxhash::xxh3_64(black_box(&bytes)));
    }
...
mod xxh3_128 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::xxhash::xxh3_128(black_box(&bytes)));
    }
...
mod xxh3_64_seeded {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::xxhash::xxh3_64_with_seed(black_box(&bytes), SEED));
    }
...
mod xxh3_128_seeded {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::xxhash::xxh3_128_with_seed(black_box(&bytes), SEED));
    }
...
mod xxh3_64_secret {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher.counter(BytesCount::new(len)).bench(|| {
            hashcrew::xxhash::xxh3_64_with_secret(black_box(&bytes), black_box(&secret)).unwrap()
        });
    }
...
mod xxh3_128_secret {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        let secret = input(hashcrew::xxhash::DEFAULT_SECRET_SIZE);
        bencher.counter(BytesCount::new(len)).bench(|| {
            hashcrew::xxhash::xxh3_128_with_secret(black_box(&bytes), black_box(&secret)).unwrap()
        });
    }
...
mod xxh3_64_seed_and_secret {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        let secret = input(hashcrew::xxhash::DEFAULT_SECRET_SIZE);
        bencher.counter(BytesCount::new(len)).bench(|| {
            hashcrew::xxhash::xxh3_64_with_seed_and_secret(
                black_box(&bytes),
                SEED,
                black_box(&secret),
            )
...
mod xxh3_128_seed_and_secret {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        let secret = input(hashcrew::xxhash::DEFAULT_SECRET_SIZE);
        bencher.counter(BytesCount::new(len)).bench(|| {
            hashcrew::xxhash::xxh3_128_with_seed_and_secret(
                black_box(&bytes),
                SEED,
                black_box(&secret),
            )
...
mod murmur3_x86_32 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::murmur::murmur3_x86_32(black_box(&bytes), 0));
    }
...
mod murmur3_x86_128 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::murmur::murmur3_x86_128(black_box(&bytes), 0));
    }
...
mod murmur3_x64_128 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::murmur::murmur3_x64_128(black_box(&bytes), 0));
    }
...
mod fnv1a_32 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::fnv::fnv1a_32(black_box(&bytes)));
    }
}
...
mod fnv1a_64 {
    ...
    fn hashcrew(bencher: Bencher<'_, '_>, len: usize) {
        ...
        bencher
            .counter(BytesCount::new(len))
            .bench(|| hashcrew::fnv::fnv1a_64(black_box(&bytes)));
    }
