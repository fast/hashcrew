...
| Target | Coverage |
|---|---|
| `throughput` | Every supported one-shot variant from 1 byte to 1 MiB, including seeded CityHash and XXH3 APIs and the XXH3 240/241-byte boundary |
| `streaming` | Every streaming-capable variant at 4 KiB / 64 B chunks, 64 KiB / 1 KiB chunks, and 1 MiB / 64 KiB chunks |
